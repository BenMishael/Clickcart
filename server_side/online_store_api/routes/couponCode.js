...
router.get('/', asyncHandler(async (req, res) => {
    console.log('GET /coupons - Request received');
    try {
        ...
        console.log('GET /coupons - Response sent');
    } catch (error) {
...
router.get('/:id', asyncHandler(async (req, res) => {
    console.log(`GET /coupons/${req.params.id} - Request received`);
    try {
        ...
        console.log(`GET /coupons/${req.params.id} - Response sent`);
    } catch (error) {
        res.status(500).json({ success: false, message: error.message });
        console.error(`GET /coupons/${req.params.id} - Error:`, error.message);
    }
}));
